function love.conf(t)
    ...
    t.window.title = "Electric Sheep Editor"    -- The window title (string)
    t.window.icon = nil                 -- Filepath to an image to use as the window's icon (string)
    t.window.width = 960                -- The window width (number)
    t.window.height = 540               -- The window height (number)
    t.window.borderless = false         -- Remove all border visuals from the window (boolean)!!!! This is kinda cool
    t.window.resizable = false          -- Let the window be user-resizable (boolean)
    t.window.minwidth = 540             -- Minimum window width if the window is resizable (number)
